...
import { PrismaTransactionDecisionStore } from './infrastructure/persistence/prisma-transaction-decision.store';
...
const useCaseProviders: Provider[] = [
  {
    provide: ApplyTransactionStatusUseCase,
    useFactory: (store: TransactionDecisionStore) => new ApplyTransactionStatusUseCase(store),
    inject: [TRANSACTION_DECISION_STORE],
  },
  {
